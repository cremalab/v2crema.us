...
/***/ function(module, exports, __webpack_require__) {
	...
	var serviceTextMobile = []; //this is only loaded if screen size is 800 pixels or less
	...
	(0, _jquery2.default)('.mobile-vid-wrapper').on('swipe', function (event, slick, direction) {
	  // console.log(slick)
	...
	(0, _jquery2.default)(document).ready(function () {
	  ...
	  (0, _jquery2.default)('.mobile-vid-wrapper').magnificPopup({
	    delegate: 'a',
	    type: 'iframe',
	    alignTop: true,
	    iframe: {
	  ...
	  serviceTextMobile = (0, _jquery2.default)('.service-text-mobile');
