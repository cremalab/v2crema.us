	...
	(0, _jquery2.default)(document).ready(function () {
	  ...
	  new Waypoint({
	    ...
	    handler: function handler(direction) {
	      var el_style = document.getElementById('cards-wrapper').style;
	      if (direction == 'down') {
	  ...
	  (0, _jquery2.default)('#slide-btn-0').click(function () {
	    (0, _jquery2.default)('#showcase').css('transform', "translateY(0)");
	    (0, _jquery2.default)('#slide-btn-1 > div').removeClass('clicked');
	    (0, _jquery2.default)('#slide-btn-2 > div').removeClass('clicked');
	    (0, _jquery2.default)('#slide-btn-0 > div').addClass('clicked');
	  });
	  (0, _jquery2.default)('#slide-btn-1').click(function () {
	    (0, _jquery2.default)('#showcase').css('transform', "translateY(-33.3%)");
	    (0, _jquery2.default)('#slide-btn-0 > div').removeClass('clicked');
	    (0, _jquery2.default)('#slide-btn-2 > div').removeClass('clicked');
	    (0, _jquery2.default)('#slide-btn-1 > div').addClass('clicked');
	    (0, _jquery2.default)('#slide-btn-1 > div').removeClass('pulse');
	  });
	  (0, _jquery2.default)('#slide-btn-2').click(function () {
	    (0, _jquery2.default)('#showcase').css('transform', "translateY(-66.6%)");
	    (0, _jquery2.default)('#slide-btn-0 > div').removeClass('clicked');
	    (0, _jquery2.default)('#slide-btn-1 > div').removeClass('clicked');
